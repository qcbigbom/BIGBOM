...
public class AnalysisPage extends commonFunction {
	...
	public void hoverToolTipEmailResetPassword() {
		waitVisible(LoginPageUI.TOOLTIPEMAILFORGOT_BTN);
		hover(LoginPageUI.TOOLTIPEMAILFORGOT_BTN);
	}
...
//input email password đăng nhập FB
	...
	public void clickLinkForgotPassword() {
		waitVisible(LoginPageUI.FORGOTPASSWORD_LINK);
		click(LoginPageUI.FORGOTPASSWORD_LINK);
	}

	public void clickButtonCancel() {
		waitVisible(LoginPageUI.CANCEL_BTN);
		click(LoginPageUI.CANCEL_BTN);
	}

	public void clickButtonGetOTP() {
		waitVisible(LoginPageUI.GETOTP_BTN);
		click(LoginPageUI.GETOTP_BTN);
	}

	public void inputEmailForgotPassword(String value) {
		waitVisible(LoginPageUI.EMAILFORGOT_TXT);
		clear(LoginPageUI.EMAILFORGOT_TXT);
		input(LoginPageUI.EMAILFORGOT_TXT, value);
	}
}
